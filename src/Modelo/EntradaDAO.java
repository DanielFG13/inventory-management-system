...
public class EntradaDAO {
    ...
    public int sumar(Entrada entrada) {
        try {
            ...
            long cantidad = sumarCantidad(entrada.cantidad, cantidadActual);
    ...
    public long sumarCantidad(long cantidadAnterior, long cantidadActual) {
        return cantidadAnterior + cantidadActual;
    }
