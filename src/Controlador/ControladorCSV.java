...
public class ControladorCSV implements ActionListener {
    ...
    public void guardarArchivoStock(File archivo, List<Stock> listaStock) {
        ...
        try {
            ...
            for (int i = 0; i < listaStock.size(); i++) {
                ...
                linea = stock.getId() + "," + stock.getCantidadActual() + "," + stock.getCantidadMinima() 
    ...
    public void guardarArchivoGasto(File archivo,  List<Entrada> listaEntrada) {  
        ...
        try {
            ...
            String linea = "id" + "," + "Cantidad" + "," + "fecha" + "," + "Producto" + "," +
                    "Precio" + "," + "Costo total de producto";
            pw.println(linea);
            ...
            for (int i = 0; i < listaEntrada.size(); i++) {
                ...
                linea = entrada.getId() + "," + cantidad + "," + entrada.getFecha().toString() + "," +
                        producto.getNombre() + "," + precio + "," + (total);
                pw.println(linea);
                costo_total += total;
            }
